...
L.Map = L.Class.extend({
    ...
    //地图上任意一点方法，方法是，以任意一点进行缩放操作，然后计算中心点位置，然后在以中心点进行缩放操作
    ...
    //获得屏幕原点的坐标，相对整张地图而言,屏幕中心点的坐标是根据
    //瓦片容器的相对屏幕原点的坐标
	...
	_getNewTopLeftPoint: function (center, zoom) {
        ...
        //获得中心点经纬度的像素坐标，相对坐标原点的像素坐标，坐标原点在左上，和屏幕的显示坐标系是一致的
...
L.TileLayer = L.Class.extend({
	...
	_addTile: function (tilePoint, container) {
		...
		// get unused tile - or create a new tile,创建img对象
...
L.Icon.Default = L.Icon.extend({
	...
	_getIconUrl: function (name) {
		...
		var path = "/WebGis/Leaflet-0.7.7/images";
...
L.Marker.include({
    ...
    */
    ...
    /*
        绑定弹出层，一个marker对应一个弹出层，如果要更改弹出层，就要修改弹出层的位置
...
L.Path = L.Path.extend({
	...
	_initStyle: function () {
	    ...
	    //在线段中间添加箭头
		if (this.options.bEndArrow) {
		    this._path.setAttribute('marker-end', 'url(#arrow)');
		}
...
L.Map.include({
	_initPathRoot: function () {
		if (!this._pathRoot) {
			...
			this._pathRoot.appendChild(oDefs);
