...
export default {
    ...
    vechileVideoData(state, data){
        state.vechileVideoData = data
    },
    commitVechileVideoData_frame(state, data){
        state.vechileVideoData_frame = data
    },
    commitRetTree(state, data){
        state.retTree = data
    }
}
