...
<script>/* eslint-disable indent,linebreak-style,quotes,no-console,semi,no-var,no-undef,no-unused-vars,no-redeclare */
        ...
        ztreeItem: {
            ...
            template:
				...
				<a  @mouseenter='enterFunc(model)' @mouseleave='leaveFunc(model)'  @contextmenu.prevent='cxtmenufunc(model)'>
				    ...
				    <span :class='model.iconClass' class="ex-icon" v-show='model.iconClass' v-else></span>
