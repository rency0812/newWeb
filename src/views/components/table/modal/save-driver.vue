<template>
    ...
    <div class="extra-button-container">
        ...
        <Modal v-model="modalShow" width="700" :draggable="true" :mask-closable="false" class="layou-modal-input">
            ...
            <div>
                <form-ext :formCfg="saveModalCfg" :formModal="editModal" :isShow="modalShow" @updateFormData="updateFormData" class="form-col-2"></form-ext>
        ...
        data() {
            return {
                ...
                saveModalCfg: [
                    ...
                    {id: 11, type: 'date', label: '*办证日期', name: 'licenseTime'},
                    {id: 12, type: 'date', label: '*起始日期', name: 'licenseStartTime'},
                    {id: 13, type: 'date', label: '*截至日期', name: 'licenseEndTime'},
                    {id: 14, type: 'input', label: '从业资格证号', name: 'qualificationCertificate'},
                    {id: 15, type: 'input', label: '发证机关', name: 'licenseUrl'},
                    // {id: 16, type: 'upload-file', label: '证件照', name: 'licensePicUrl'},
                    // {id: 17, type: 'upload-file', label: '照片', name: 'picUrl'}
                ],
