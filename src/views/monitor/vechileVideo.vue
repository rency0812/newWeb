...
<!--                <mapMain v-if="container.indexOf('map') > -1" :mapWidth="mapWidth" :mapHeight="mapHeight"-->
<!--                         :mapControl="mapControl"/>-->
<!--                <mapMain  :mapWidth="mapWidth" :mapHeight="mapHeight"-->
<!--                         :mapControl="mapControl"/>-->
                <videoMain v-if="container.indexOf('video') > -1"/>
            </div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                tabClose: false,
                container: 'map',      // 调用主体组件的类型，默认为地图--map ，其余:视频--video ， 扬尘噪音--air ， 门禁组件--door
